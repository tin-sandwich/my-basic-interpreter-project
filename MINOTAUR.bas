...
135 T = 0
150 S1 = INT(RND(1) * 10) + 1
151 S2 = INT(RND(1) * 10) + 1
152 S3 = INT(RND(1) * 3) + 1
...
2110 PRINT
2120 PRINT
2130 PRINT TAB(21)" HERE ARE YOUR CONTROL FUNCTIONS"
...
2770 GOTO 2720
2780 FOR A=1 TO 10
2790 IF X1=B(A) AND Y1=C(A) THEN 260
2800 NEXT A
2810 PRINT
2820 GO TO 280
2830 PRINT
